    ...
    'Alianza': {
        ...
        leaders: [
            { name: '<strong>Nirlem, el paladín</strong>', points: 15, 
			 		...
			 		extraInfo: '<strong>Armas:\n </strong> <strong>Ajusticiadora: Contundente:</strong>Reduce en 1 el número objetivo de la Tirada de Daño (mín. 2); si el ataque tiene POT 4 o más, recibe un 1 adicional (2 en total). \n<strong>Basión de la Verdad: Defensiva</strong> Este arma no hace ninguna tirada de da ni provoca tiradas de moral por ganar la tirade en combate. \n<strong>¡Levántate y lucha!:</strong> El objetivo aliado que no sea este combatiente sana 1 herida. <strong>Sphere:</strong> Elige un objetivo aliado adicional que no sea este combatiente', 
