const factions = {
    'Adeptos de Malesur': {
        ...
        veterans: [
            { name: 'Artífice veterano', points: 1, characteristics: 'El líder obtiene DOM +1' },
            { name: 'Mando veterano', points: 1, characteristics: 'El líder obtiene ORD +1' },
			{ name: 'Arcanista veterano', points: 1, characteristics: 'El líder obtiene POD +2' }
        ]
    },
    'Vástagos de Kurgan': {
...
<br>Esta orden puede darse después de lanzar una tirada de daño con un arma a melé. Repite la tirada de daño.`,
    ...
    'Alianza': {
        ...
        leaders: [
            { name: '<strong>Nirlem, el paladín</strong>', points: 15, 
			 		characteristics: '\nDOM:2 EST:3 ORD:3 \nMOV:3 DES:4/5 POT:3 CON:5 ARC:4 HER:6 TAM:3 AME:1 COR:5', 
			 		extraInfo: '<strong>Armas:\n </strong> <strong>Ajusticiadora:</strong><em> Contundente:</em>Reduce en 1 el número objetivo de la Tirada de Daño (mín. 2); si el ataque tiene POT 4 o más, recibe un 1 adicional (2 en total). \n<strong>Bastión de la Verdad: Defensiva</strong> Este arma no hace ninguna tirada de da ni provoca tiradas de moral por ganar la tirade en combate. \n<strong>¡Levántate y lucha! - 4":</strong> El objetivo aliado que no sea este combatiente sana 1 herida. <strong>Sphere:</strong> Elige un objetivo aliado adicional que no sea este combatiente', 
			 		comment: 'Armas:\n Ajusticiadora: Contundente:Reduce en 1 el número objetivo de la Tirada de Daño (mín. 2); si el ataque tiene POT 4 o más, recibe un 1 adicional (2 en total). \nBasión de la Verdad: Defensiva Este arma no hace ninguna tirada de da ni provoca tiradas de moral por ganar la tirade en combate. \n¡Levántate y lucha!: El objetivo aliado que no sea este combatiente sana 1 herida. Sphere: Elige un objetivo aliado adicional que no sea este combatiente' },
	   		{ name: '<strong>Rodanes, Brazo de metal</strong>', points: 16, 
			 		characteristics: '\nDOM:2 EST:4 ORD:4 \nMOV:3 DES:5 POT:3 CON:5 ARC:4 HER:6 TAM:3 AME:1 COR:5', 
			 		extraInfo: '<strong>Armas:\n </strong> <strong>Integridad:</strong><em> Intimidante</em> Si se obtiene al menos un <strong>Sphere</strong> en la tirada de ataque, este combatiente obtiene <strong>AME+1</strong> hasta el final de la activación \n<strong>¡Legión, con el corazón!- 4":</strong> El objetivo aliado que no sea este combatiente deja de estar cansado.<strong>Sphere:</strong> Elige un objetivo aliado adicional que no sea este combatiente', 
			 		comment: 'Armas:\n Integridad: intimidante Si se obtiene al menos un Sphere en la tirada de ataque, este combatiente obtiene AME+1 hasta el final de la activación \n¡Legión, con el corazón!: El objetivo aliado que no sea este combatiente deja de estar cansado. Sphere: Elige un objetivo aliado adicional que no sea este combatiente' },
           { name: '<strong>Taem, la carnicera</strong>', points: 15, 
			 		characteristics: '\nDOM:2 EST:3 ORD:4 \nMOV:4 DES:4 POT:3 CON:4 ARC:4 HER:6 TAM:3 AME:1 COR:5', 
			 		extraInfo: '<strong>Armas:\n </strong> <strong>Hacha de carnicera:</strong><em>Intimidante:</em> Si se obtiene al menos un Sphere en la Tirada de Ataque, obtiene <strong>AME 1</strong> hasta el final de la activación. \n<strong>¡Ven aqui!- 4":</strong> si el objetivo es de <strong>TAM 4</strong> o inferior desplazalo 4" acercandolo hacia este combatiente. <strong>Sphere:</strong> El objetivo sufre 1 herida.', 
			 		comment: 'Armas:\n Hacha de carnicera: Intimidante: Si se obtiene al menos un Sphere en la Tirada de Ataque, obtiene AME 1 hasta el final de la activación. \n¡Ven aqui!- 4": si el objetivo es de TAM 4 o inferior desplazalo 4" acercandolo hacia este combatiente. Sphere: El objetivo sufre 1 herida.' },
...
const options = {
    ...
    'Alianza': [
		...
		{ name: 'Legion', description: 'Esta subfacción tiene acceso a todos los combatientes de la facción, pero no obtiene ninguna regla especial.'},
		{ name: 'Mercenarias', description: 'Esta subfacción tiene acceso a todos los combatientes de la facción, pero no obtiene ninguna regla especial.'}
	]
};
